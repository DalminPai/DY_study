...
rootfile=$(basename $1)
array_est=("denominator_pt" "denominator_pt_barrel" "denominator_pt_endcap"
...
array_app=("histDijet1" "histDijet2" "histSameDijet1" "histSameDijet2"
			...
			"histPass" "histFail"
			## -- before applying FR -- ##
			"histDijet" "histSameDijet" "fitDijet" "fitSameDijet" "rapDijet" "rapSameDijet" "histWJets" "histSameWJets" "fitWJets" "fitSameWJets" "rapWJets" "rapSameWJets"
			)
array_var=${array_est[@]}
