...
void my_estimateFR()
{
	...
	double fit_value_barrel[9] = {0, 2.1672e+07, 1.4593e+07, 4.6877e+06, 1.4304e+06, 6.7331e+04, 8.4353e+04, 3.4200e+04, 1.1022e+04};
	double fit_value_endcap[9] = {0, 1.0308e+07, 1.1846e+07, 3.3025e+06, 5.8866e+05, 2.6427e+04, 6.1413e+04, 2.3134e+04, 6.9664e+03};
	...
	TCanvas* c__ = new TCanvas("c__","",800,800);
	c__->cd();

	TPad* canv = new TPad("padc1_1","padc1_1",0.01,0.01,0.99,0.99);
	canv->Draw();
	canv->cd();
	...
	//c__->Print("../bin/print/FR_Barrel.pdf");
	c__->SaveAs("../bin/print/FR_Barrel.pdf");
	...
	//c__->Print("../bin/print/FR_Endcap.pdf");
	c__->SaveAs("../bin/print/FR_Endcap.pdf");
