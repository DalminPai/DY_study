...
void DYAnalyzer::SetupMCsamples_Moriond17( TString Type, vector<TString> *ntupleDirectory, vector<TString> *Tag, vector<Double_t> *Xsec, vector<Double_t> *nEvents )
{
	...
	else if( Type == "DYEE_M50to200" )
	{
		cout << "# events should be adjusted later" << endl;
		// -- Signal binned samples -- //
		ntupleDirectory->push_back( "DYLL_M50toInf" ); Tag->push_back( "DYEE_M50to200" ); Xsec->push_back( 1873.52 + 76.2401 ); nEvents->push_back( 1.0 ); //nEvents: sum of DYEE weights
	}
...
//			cout << "Reco: bin# = [" << iter_x << ", " << iter_y << "]" << " eta = " << xx_reco[iter_x] << " sf = " << yy_reco[iter_x] << endl;
	...
	cout << "Trigger part should be debugged" << endl;
...
Double_t DYAnalyzer::EfficiencySF_EventWeight_electron(Electron ele1, Electron ele2)
{
	...
	Double_t Eff_Trig_tl_data = Eff_HLT_Leg1_data[etabin1_Trig][ptbin1_Trig] * Eff_HLT_Leg2_data[etabin2_Trig][ptbin2_Trig];
	Double_t Eff_Trig_lt_data = Eff_HLT_Leg2_data[etabin1_Trig][ptbin1_Trig] * Eff_HLT_Leg1_data[etabin2_Trig][ptbin2_Trig];
	Eff_EventTrig_data = Eff_Trig_tl_data + (1 - Eff_Trig_tl_data) * Eff_Trig_lt_data;

	Double_t Eff_Trig_tl_MC = Eff_HLT_Leg1_MC[etabin1_Trig][ptbin1_Trig] * Eff_HLT_Leg2_MC[etabin2_Trig][ptbin2_Trig];
	Double_t Eff_Trig_lt_MC = Eff_HLT_Leg2_MC[etabin1_Trig][ptbin1_Trig] * Eff_HLT_Leg1_MC[etabin2_Trig][ptbin2_Trig];
	Eff_EventTrig_MC = Eff_Trig_tl_MC + (1 - Eff_Trig_tl_MC) * Eff_Trig_lt_MC;
