...
//                Update "Find_muon_PtBin/EtaBin_ID/Iso/Trig_new"
//                Add "DYLL_M100(200)to200(400)_fixed"
//                Introduce "GenMuonPt"
// -- 2019.02.14: Add PU reweighting tool of SMP-17-010
//
//
#pragma once
...
void DYAnalyzer::SetupMCsamples_Moriond17( TString Type, vector<TString> *ntupleDirectory, vector<TString> *Tag, vector<Double_t> *Xsec, vector<Double_t> *nEvents )
{
	...
	else if( Type == "DYMuMu_M50to100" )
	{
		//cout << "# events should be adjusted later" << endl;
		// -- Signal binned samples -- //
		ntupleDirectory->push_back( "DYLL_M50toInf" ); Tag->push_back( "DYMuMu_M50to100" ); Xsec->push_back( 1873.52 ); nEvents->push_back( 26175605.0 ); //nEvents: sum of DYMuMu weights
	}
	...
	else if( Type == "DYMuMu_M100toInf" )
	{
		//cout << "# events should be adjusted later" << endl;
		// -- Signal binned samples -- //
		ntupleDirectory->push_back( "DYLL_M100to200_fixed" ); Tag->push_back( "DYMuMu_M100to200" ); Xsec->push_back( 76.2401 ); nEvents->push_back( 3176762.0 ); //nEvents: sum of DYMuMu weights
		ntupleDirectory->push_back( "DYLL_M200to400_fixed" ); Tag->push_back( "DYMuMu_M200to400" ); Xsec->push_back( 2.67606 ); nEvents->push_back( 560322.0 ); //nEvents: sum of DYMuMu weights
	...
	else if( Type == "DYEE_M50to100" )
	{
		//cout << "# events should be adjusted later" << endl;
		// -- Signal binned samples -- //
		ntupleDirectory->push_back( "DYLL_M50toInf" ); Tag->push_back( "DYEE_M50to100" ); Xsec->push_back( 1873.52 ); nEvents->push_back( 26166194.0 ); //nEvents: sum of DYEE weights
	}
	...
	else if( Type == "DYEE_M100toInf" )
	{
		//cout << "# events should be adjusted later" << endl;
		// -- Signal binned samples -- //
		ntupleDirectory->push_back( "DYLL_M100to200_fixed" ); Tag->push_back( "DYEE_M100to200" ); Xsec->push_back( 76.2401 ); nEvents->push_back( 3179506.0 ); //nEvents: sum of DYEE weights
		ntupleDirectory->push_back( "DYLL_M200to400_fixed" ); Tag->push_back( "DYEE_M200to400" ); Xsec->push_back( 2.67606 ); nEvents->push_back( 560818.0 ); //nEvents: sum of DYEE weights
...
Bool_t DYAnalyzer::Separate_ttbarSample(TString Tag, NtupleHandle *ntuple, vector<GenOthers> *GenTopCollection)
{
	...
	if( Tag.Contains("ttbar") && Tag.Contains("M") )
	{
		vector<GenOthers> GenOthersCollection;
		Int_t NGenOthers = ntuple->nGenOthers;
		for(Int_t i_gen=0; i_gen<NGenOthers; i_gen++)
...
Int_t DYAnalyzer::Find_muon_PtBin_ID(Double_t Pt)
{
	...
	{
		if( Pt == PtBinEdges[i] ) cout << "WARNING: (ID) muon pt = " << Pt << endl;
	}
...
Int_t DYAnalyzer::Find_muon_PtBin_Iso(Double_t Pt)
{
	...
	for(Int_t i=0; i<nPtBins+1; i++)
	{
		if( Pt == PtBinEdges[i] ) cout << "WARNING: (Iso) muon pt = " << Pt << endl;
	}
...
Int_t DYAnalyzer::Find_muon_PtBin_Trig_new(Double_t Pt)
{
	...
	for(Int_t i=0; i<nPtBins+1; i++)
	{
		if( Pt == PtBinEdges[i] ) cout << "WARNING: (Trig new) muon pt = " << Pt << endl;
	}
...
Int_t DYAnalyzer::Find_muon_EtaBin_ID(Double_t eta)
{
	...
	{
		if( fabs(eta) == EtaBinEdges[i] ) cout << "WARNING: (ID) muon |eta| = " << fabs(eta) << endl;
	}
...
Int_t DYAnalyzer::Find_muon_EtaBin_Iso(Double_t eta)
{
	...
	for(Int_t i=0; i<nEtaBins+1; i++)
	{
		if( fabs(eta) == EtaBinEdges[i] ) cout << "WARNING: (Iso) muon |eta| = " << fabs(eta) << endl;
	}
...
Int_t DYAnalyzer::Find_muon_EtaBin_Trig(Double_t eta)
{
	...
	for(Int_t i=0; i<nEtaBins+1; i++)
	{
		if( fabs(eta) == EtaBinEdges[i] ) cout << "WARNING: (Trig) muon |eta| = " << fabs(eta) << endl;
	}
