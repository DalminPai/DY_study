...
void MuMu_TightID_PFIso_NewMuonSF_20181012(Int_t debug, Int_t type, Int_t remainder = 9999, Int_t isTopPtReweighting = 0, TString HLTname = "IsoMu24_OR_IsoTkMu24")
{
	...
	// -- Output ROOTFile -- //	
	//TString Output_ROOTFile = BaseDir+"/RESULT/MuMu/ROOTFile_20181012_MuMu_TightID_PFIso_NewMuonSF_"
	//TString Output_ROOTFile = BaseDir+"/RESULT/MuMu/ROOTFile_20181119_MuMu_TightID_PFIso_NewMuonSF_"
	TString Output_ROOTFile = BaseDir+"/RESULT/MuMu/ROOTFile_20181213_MuMu_TightID_PFIso_NewMuonSF_with_PrefiringWeight_"
	...
	for(Int_t i_tup = 0; i_tup<Ntup; i_tup++)
	{
		...
		if( isMC == kTRUE )
		{
			...
			if( ntupleDirectory[i_tup].Contains("_fixed") || ntupleDirectory[i_tup].Contains("WJetsToLNu_amcatnlo") ) version = "v2.3";
		...
		// -- Gen-level in Z-peak -- //
		TH1D *h_Gen_Zpeak_mass = (TH1D*)h_mass->Clone("h_Gen_Zpeak_mass_"+Tag[i_tup]);
		TH1D *h_Gen_Zpeak_mass_fine = (TH1D*)h_mass_fine->Clone("h_Gen_Zpeak_mass_fine_"+Tag[i_tup]);
		TH1D *h_Gen_Zpeak_diPt = (TH1D*)h_diPt->Clone("h_Gen_Zpeak_diPt_"+Tag[i_tup]);
		TH1D *h_Gen_Zpeak_rapi = (TH1D*)h_rapi->Clone("h_Gen_Zpeak_rapi_"+Tag[i_tup]);
		TH1D *h_Gen_Zpeak_pT = (TH1D*)h_pT->Clone("h_Gen_Zpeak_pT_"+Tag[i_tup]);
		TH1D *h_Gen_Zpeak_leadPt = (TH1D*)h_pT->Clone("h_Gen_Zpeak_leadPt_"+Tag[i_tup]);
		TH1D *h_Gen_Zpeak_subPt = (TH1D*)h_pT->Clone("h_Gen_Zpeak_subPt_"+Tag[i_tup]);
		TH1D *h_Gen_Zpeak_eta = (TH1D*)h_eta->Clone("h_Gen_Zpeak_eta_"+Tag[i_tup]);
		TH1D *h_Gen_Zpeak_leadEta = (TH1D*)h_eta->Clone("h_Gen_Zpeak_leadEta_"+Tag[i_tup]);
		TH1D *h_Gen_Zpeak_subEta = (TH1D*)h_eta->Clone("h_Gen_Zpeak_subEta_"+Tag[i_tup]);
		TH1D *h_Gen_Zpeak_phi = (TH1D*)h_phi->Clone("h_Gen_Zpeak_phi_"+Tag[i_tup]);
		TH1D *h_Gen_Zpeak_leadPhi = (TH1D*)h_phi->Clone("h_Gen_Zpeak_leadPhi_"+Tag[i_tup]);
		TH1D *h_Gen_Zpeak_subPhi = (TH1D*)h_phi->Clone("h_Gen_Zpeak_subPhi_"+Tag[i_tup]);
		...
		{	
			...
			if( TriggerFlag == kTRUE && GenFlag == kTRUE && GenFlag_top == kTRUE )
			{
				...
				if( isPassEventSelection == kTRUE )
				{
					...
					{
						h_Zpeak_mass->Fill( reco_M, TotWeight * PUWeight * effweight );
						h_Zpeak_mass_fine->Fill( reco_M, TotWeight * PUWeight * effweight );
						h_Zpeak_diPt->Fill( reco_Pt, TotWeight * PUWeight * effweight );
						h_Zpeak_rapi->Fill( reco_rapi, TotWeight * PUWeight * effweight );
						h_Zpeak_pT->Fill( mu1.Pt, TotWeight * PUWeight * effweight );
						h_Zpeak_pT->Fill( mu2.Pt, TotWeight * PUWeight * effweight );
						h_Zpeak_eta->Fill( mu1.eta, TotWeight * PUWeight * effweight );
						h_Zpeak_eta->Fill( mu2.eta, TotWeight * PUWeight * effweight );
						h_Zpeak_phi->Fill( mu1.phi, TotWeight * PUWeight * effweight );
						h_Zpeak_phi->Fill( mu2.phi, TotWeight * PUWeight * effweight );

						h_Zpeak_leadPt->Fill( mu1.Pt, TotWeight * PUWeight * effweight );
						h_Zpeak_leadEta->Fill( mu1.eta, TotWeight * PUWeight * effweight );
						h_Zpeak_leadPhi->Fill( mu1.phi, TotWeight * PUWeight * effweight );
						h_Zpeak_subPt->Fill( mu2.Pt, TotWeight * PUWeight * effweight );
						h_Zpeak_subEta->Fill( mu2.eta, TotWeight * PUWeight * effweight );
						h_Zpeak_subPhi->Fill( mu2.phi, TotWeight * PUWeight * effweight );

						// Dilepton pT cut : 30GeV
						if( 30 < reco_Pt )
						{
							h_Zpeak_PtCut_mass->Fill( reco_M, TotWeight * PUWeight * effweight );
							h_Zpeak_PtCut_mass_fine->Fill( reco_M, TotWeight * PUWeight * effweight );
							h_Zpeak_PtCut_diPt->Fill( reco_Pt, TotWeight * PUWeight * effweight );
							h_Zpeak_PtCut_rapi->Fill( reco_rapi, TotWeight * PUWeight * effweight );
							h_Zpeak_PtCut_pT->Fill( mu1.Pt, TotWeight * PUWeight * effweight );
							h_Zpeak_PtCut_pT->Fill( mu2.Pt, TotWeight * PUWeight * effweight );
							h_Zpeak_PtCut_eta->Fill( mu1.eta, TotWeight * PUWeight * effweight );
							h_Zpeak_PtCut_eta->Fill( mu2.eta, TotWeight * PUWeight * effweight );
							h_Zpeak_PtCut_phi->Fill( mu1.phi, TotWeight * PUWeight * effweight );
							h_Zpeak_PtCut_phi->Fill( mu2.phi, TotWeight * PUWeight * effweight );

							h_Zpeak_PtCut_leadPt->Fill( mu1.Pt, TotWeight * PUWeight * effweight );
							h_Zpeak_PtCut_leadEta->Fill( mu1.eta, TotWeight * PUWeight * effweight );
							h_Zpeak_PtCut_leadPhi->Fill( mu1.phi, TotWeight * PUWeight * effweight );
							h_Zpeak_PtCut_subPt->Fill( mu2.Pt, TotWeight * PUWeight * effweight );
							h_Zpeak_PtCut_subEta->Fill( mu2.eta, TotWeight * PUWeight * effweight );
							h_Zpeak_PtCut_subPhi->Fill( mu2.phi, TotWeight * PUWeight * effweight );
						}
					} //End of Z-peak
