...
// -- Electron Channel -- //
// -- Modified from "EE_PVz_20181012.C": 30 Oct. 2018
// -- Add L1 prefiring inefficiency: 30 Oct. 2018
void EE_L1_prefiring_ineff_20181030(Int_t debug, Int_t type, Int_t remainder = 9999, Int_t isTopPtReweighting = 0, TString HLTname = "Ele23Ele12")
{
	...
	// -- Output ROOTFile -- //	
	TString Output_ROOTFile = BaseDir+"/RESULT/EE/ROOTFile_20181030_EE_L1_prefiring_ineff_"+TString::Itoa(type,10)+"_"+TString::Itoa(remainder,10)+"_"
