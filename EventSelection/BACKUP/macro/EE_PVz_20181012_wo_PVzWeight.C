...
void EE_PVz_20181012_wo_PVzWeight(Int_t debug, Int_t type, Int_t remainder = 9999, Int_t isTopPtReweighting = 0, TString HLTname = "Ele23Ele12")
{
	...
	// -- Output ROOTFile -- //	
	//TString Output_ROOTFile = BaseDir+"/RESULT/EE/ROOTFile_20181012_EE_PVz_reweighting_"+TString::Itoa(type,10)+"_"+TString::Itoa(remainder,10)+"_"
	TString Output_ROOTFile = BaseDir+"/RESULT/EE/ROOTFile_20181205_EE_with_PrefiringWeight_"+TString::Itoa(type,10)+"_"+TString::Itoa(remainder,10)+"_"
