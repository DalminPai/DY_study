...
// -- Modified from "EE_PVz_20181012.C": 12 Feb. 2019 -- //
//
//
void EE_for_validation(Int_t debug, Int_t type, Int_t remainder = 9999, Int_t isTopPtReweighting = 0, TString HLTname = "Ele23Ele12")
{
	...
	// -- Signal MC samples -- //
	else if( type == 10 ) Type = "DYEE_M50toInf";
	else if( type == 11 ) Type = "DYEE_M10to50";
	else if( type == 12 ) Type = "DYEE_M50to100";
	else if( type == 13 ) Type = "DYEE_M100toInf";
	...
	// -- Output ROOTFile -- //	
	TString Output_ROOTFile = BaseDir+"/RESULT/EE/ROOTFile_20190212_EE_for_validation_"
	...
	for(Int_t i_tup = 0; i_tup<Ntup; i_tup++)
	{
		...
		{
			TString version = "v2.0";

			if( remainder == 9999 )
			{
				chain->Add(NtupleLocation+"/"+version+"/"+DataLocation+"/*.root");
				if(type==7) chain->Add(NtupleLocation+"/"+version+"/DoubleEG_Run2016Hver3/*.root");
			}
			else
			{
				for(Double_t ii=1; ii<=1500; ii++)
				...
				if(type==7 && remainder==0) chain->Add(NtupleLocation+"/"+version+"/DoubleEG_Run2016Hver3/*.root");
			}
		}
		...
		TH1D *h_subEta[ncorr];
		TH1D *h_etaSC[ncorr];
		TH1D *h_leadEtaSC[ncorr];
		TH1D *h_subEtaSC[ncorr];
		TH1D *h_phi[ncorr];
		...
		TH1D *h_Zpeak_etaSC[ncorr];
		TH1D *h_Zpeak_leadEtaSC[ncorr];
		TH1D *h_Zpeak_subEtaSC[ncorr];
		...
		{	
			...
			h_etaSC[i] = (TH1D*)h_eta[i]->Clone("h_"+corrtype[i]+"etaSC_"+Tag[i_tup]);
			h_leadEtaSC[i] = (TH1D*)h_eta[i]->Clone("h_"+corrtype[i]+"leadEtaSC_"+Tag[i_tup]);
			h_subEtaSC[i] = (TH1D*)h_eta[i]->Clone("h_"+corrtype[i]+"subEtaSC_"+Tag[i_tup]);
			...
			h_Zpeak_etaSC[i] = (TH1D*)h_eta[i]->Clone("h_"+corrtype[i]+"Zpeak_etaSC_"+Tag[i_tup]);
			h_Zpeak_leadEtaSC[i] = (TH1D*)h_eta[i]->Clone("h_"+corrtype[i]+"Zpeak_leadEtaSC_"+Tag[i_tup]);
			h_Zpeak_subEtaSC[i] = (TH1D*)h_eta[i]->Clone("h_"+corrtype[i]+"Zpeak_subEtaSC_"+Tag[i_tup]);
		...
		{	
			...
			if( TriggerFlag == kTRUE && GenFlag == kTRUE && GenFlag_top == kTRUE )
			{
				...
				if( isPassEventSelection == kTRUE )
				{
					...
					h_mass[icorr]->Fill( reco_M, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
					h_mass_fine[icorr]->Fill( reco_M, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
					h_diPt[icorr]->Fill( reco_Pt, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
					h_rapi[icorr]->Fill( reco_rapi, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
					h_pT[icorr]->Fill( ele1.Pt, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
					h_pT[icorr]->Fill( ele2.Pt, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
					h_eta[icorr]->Fill( ele1.eta, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
					h_eta[icorr]->Fill( ele2.eta, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
					h_etaSC[icorr]->Fill( ele1.etaSC, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
					h_etaSC[icorr]->Fill( ele2.etaSC, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
					h_phi[icorr]->Fill( ele1.phi, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
					h_phi[icorr]->Fill( ele2.phi, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
					h_nVTX_woPU[icorr]->Fill( ntuple->nVertices, TotWeight * PVzWeight * effweight * PrefiringWeight );
					h_nVTX_withPU[icorr]->Fill( ntuple->nVertices, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );

					h_leadPt[icorr]->Fill( ele1.Pt, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
					h_leadEta[icorr]->Fill( ele1.eta, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
					h_leadEtaSC[icorr]->Fill( ele1.etaSC, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
					h_leadPhi[icorr]->Fill( ele1.phi, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
					h_subPt[icorr]->Fill( ele2.Pt, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
					h_subEta[icorr]->Fill( ele2.eta, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
					h_subEtaSC[icorr]->Fill( ele2.etaSC, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
					h_subPhi[icorr]->Fill( ele2.phi, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );

					if( 60 < reco_M && reco_M < 120 )
					{
						h_Zpeak_mass[icorr]->Fill( reco_M, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
						h_Zpeak_mass_fine[icorr]->Fill( reco_M, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
						h_Zpeak_diPt[icorr]->Fill( reco_Pt, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
						h_Zpeak_rapi[icorr]->Fill( reco_rapi, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
						h_Zpeak_pT[icorr]->Fill( ele1.Pt, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
						h_Zpeak_pT[icorr]->Fill( ele2.Pt, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
						h_Zpeak_eta[icorr]->Fill( ele1.eta, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
						h_Zpeak_eta[icorr]->Fill( ele2.eta, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
						h_Zpeak_etaSC[icorr]->Fill( ele1.etaSC, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
						h_Zpeak_etaSC[icorr]->Fill( ele2.etaSC, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
						h_Zpeak_phi[icorr]->Fill( ele1.phi, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
						h_Zpeak_phi[icorr]->Fill( ele2.phi, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
						h_Zpeak_nVTX_woPU[icorr]->Fill( ntuple->nVertices, TotWeight * PVzWeight * effweight * PrefiringWeight );
						h_Zpeak_nVTX_withPU[icorr]->Fill( ntuple->nVertices, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );

						h_Zpeak_leadPt[icorr]->Fill( ele1.Pt, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
						h_Zpeak_leadEta[icorr]->Fill( ele1.eta, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
						h_Zpeak_leadEtaSC[icorr]->Fill( ele1.etaSC, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
						h_Zpeak_leadPhi[icorr]->Fill( ele1.phi, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
						h_Zpeak_subPt[icorr]->Fill( ele2.Pt, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
						h_Zpeak_subEta[icorr]->Fill( ele2.eta, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
						h_Zpeak_subEtaSC[icorr]->Fill( ele2.etaSC, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
						h_Zpeak_subPhi[icorr]->Fill( ele2.phi, TotWeight * PVzWeight * PUWeight * effweight * PrefiringWeight );
					} // End of Z-peak

				} //End of event selection

				// -- Event Selection without e/gamma corrections -- //
				...
				if( isPassEventSelection0 == kTRUE )
				{
					...
					h_pT[icorr]->Fill( ele1.pTUnCorr, TotWeight );
					h_pT[icorr]->Fill( ele2.pTUnCorr, TotWeight );
					h_eta[icorr]->Fill( ele1.etaUnCorr, TotWeight );
					h_eta[icorr]->Fill( ele2.etaUnCorr, TotWeight );
					h_etaSC[icorr]->Fill( ele1.etaSCUnCorr, TotWeight );
					h_etaSC[icorr]->Fill( ele2.etaSCUnCorr, TotWeight );
					h_phi[icorr]->Fill( ele1.phiUnCorr, TotWeight );
					h_phi[icorr]->Fill( ele2.phiUnCorr, TotWeight );
					h_nVTX_woPU[icorr]->Fill( ntuple->nVertices, TotWeight );
					h_nVTX_withPU[icorr]->Fill( ntuple->nVertices, TotWeight * PUWeight );

					h_leadPt[icorr]->Fill( ele1.pTUnCorr, TotWeight );
					h_leadEta[icorr]->Fill( ele1.etaUnCorr, TotWeight );
					h_leadEtaSC[icorr]->Fill( ele1.etaSCUnCorr, TotWeight );
					h_leadPhi[icorr]->Fill( ele1.phiUnCorr, TotWeight );
					h_subPt[icorr]->Fill( ele2.pTUnCorr, TotWeight );
					h_subEta[icorr]->Fill( ele2.etaUnCorr, TotWeight );
					h_subEtaSC[icorr]->Fill( ele2.etaSCUnCorr, TotWeight );
					h_subPhi[icorr]->Fill( ele2.phiUnCorr, TotWeight );
					...
					if( 60 < reco_M && reco_M < 120 )
					{
						...
						h_Zpeak_pT[icorr]->Fill( ele1.pTUnCorr, TotWeight );
						h_Zpeak_pT[icorr]->Fill( ele2.pTUnCorr, TotWeight );
						h_Zpeak_eta[icorr]->Fill( ele1.etaUnCorr, TotWeight );
						h_Zpeak_eta[icorr]->Fill( ele2.etaUnCorr, TotWeight );
						h_Zpeak_etaSC[icorr]->Fill( ele1.etaSCUnCorr, TotWeight );
						h_Zpeak_etaSC[icorr]->Fill( ele2.etaSCUnCorr, TotWeight );
						h_Zpeak_phi[icorr]->Fill( ele1.phiUnCorr, TotWeight );
						h_Zpeak_phi[icorr]->Fill( ele2.phiUnCorr, TotWeight );
						...
						h_Zpeak_leadPt[icorr]->Fill( ele1.pTUnCorr, TotWeight );
						h_Zpeak_leadEta[icorr]->Fill( ele1.etaUnCorr, TotWeight );
						h_Zpeak_leadEtaSC[icorr]->Fill( ele1.etaSCUnCorr, TotWeight );
						h_Zpeak_leadPhi[icorr]->Fill( ele1.phiUnCorr, TotWeight );
						h_Zpeak_subPt[icorr]->Fill( ele2.pTUnCorr, TotWeight );
						h_Zpeak_subEta[icorr]->Fill( ele2.etaUnCorr, TotWeight );
						h_Zpeak_subEtaSC[icorr]->Fill( ele2.etaSCUnCorr, TotWeight );
						h_Zpeak_subPhi[icorr]->Fill( ele2.phiUnCorr, TotWeight );
					} // End of Z-peak
