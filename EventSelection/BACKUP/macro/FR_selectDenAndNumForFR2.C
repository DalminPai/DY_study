...
void FR_selectDenAndNumForFR2(Int_t debug, Int_t type, Int_t remainder = 9999, Int_t isTopPtReweighting = 0, TString HLTname = "Mu50")
{
	...
	// -- Output ROOTFile -- //	
	TString Output_ROOTFile = BaseDir+"/RESULT/FR/hist_test_re_"+TString::Itoa(type,10)+"_"+TString::Itoa(remainder,10)+"_"
