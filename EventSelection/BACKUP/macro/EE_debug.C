...
void EE_debug(Int_t debug, Int_t type, Int_t remainder = 9999, Int_t isTopPtReweighting = 0, TString HLTname = "Ele23Ele12")
{
	...
	TString Output_ROOTFile = BaseDir+"/RESULT/EE/ROOTFile_20180703_EE_LeadEtaStudy_MyIdSf_"+TString::Itoa(type,10)+"_"+TString::Itoa(remainder,10)+"_"
	...
	for(Int_t i_tup = 0; i_tup<Ntup; i_tup++)
	{
		...
		Int_t NEvents = 100000; // test using small events
			...
			if( TriggerFlag == kTRUE && GenFlag == kTRUE && GenFlag_top == kTRUE )
			{
				...
				if( isPassEventSelection == kTRUE )
				{
					...
					if( isMC == kTRUE )
					{
						...
						/*if( ele1.etaSC > 2.3 && ele2.etaSC > 2.3 )
						{
							cout << "pt1: " << ele1.Pt << "\tpt2: " << ele2.Pt << endl;
							cout << "eta1: " << ele1.etaSC << "\teta2: " << ele2.etaSC << endl;
							cout << "effweight: " << effweight << endl;
						}*/
						if( !(0 <= effweight && effweight < 2) )
						{
							cout << "pt1: " << ele1.Pt << "\tpt2: " << ele2.Pt << endl;
							cout << "eta1: " << ele1.eta << "\teta2: " << ele2.eta << endl;
						}
					}
