...
void MuMu_TightID_PFIso_Corr(Int_t debug, Int_t type, Int_t remainder = 9999, Int_t isTopPtReweighting = 0, TString HLTname = "IsoMu24_OR_IsoTkMu24")
{
	...
	// -- Output ROOTFile -- //	
	TString Output_ROOTFile = BaseDir+"/RESULT/MuMu/ROOTFile_MuMu_TightID_PFIso_v20180524_"+TString::Itoa(type,10)+"_"+TString::Itoa(remainder,10)+"_"
		...
		{	
			...
			if( TriggerFlag == kTRUE && GenFlag == kTRUE && GenFlag_top == kTRUE )
			{
				...
				if( isPassEventSelection == kTRUE )
				{
					...
					if( isMC == kTRUE )
					{
						h_BtoF_mass_fine->Fill( reco_M, TotWeight * PUWeight * effweight_BtoF );
						h_BtoF_diPt->Fill( reco_Pt, TotWeight * PUWeight * effweight_BtoF );
						h_BtoF_rapi->Fill( reco_rapi, TotWeight * PUWeight * effweight_BtoF );
						h_BtoF_pT->Fill( mu1.Pt, TotWeight * PUWeight * effweight_BtoF );
						h_BtoF_pT->Fill( mu2.Pt, TotWeight * PUWeight * effweight_BtoF );
						h_BtoF_eta->Fill( mu1.eta, TotWeight * PUWeight * effweight_BtoF );
						h_BtoF_eta->Fill( mu2.eta, TotWeight * PUWeight * effweight_BtoF );
						h_BtoF_phi->Fill( mu1.phi, TotWeight * PUWeight * effweight_BtoF );
						h_BtoF_phi->Fill( mu2.phi, TotWeight * PUWeight * effweight_BtoF );

						h_GtoH_mass_fine->Fill( reco_M, TotWeight * PUWeight * effweight_GtoH );
						h_GtoH_diPt->Fill( reco_Pt, TotWeight * PUWeight * effweight_GtoH );
						h_GtoH_rapi->Fill( reco_rapi, TotWeight * PUWeight * effweight_GtoH );
						h_GtoH_pT->Fill( mu1.Pt, TotWeight * PUWeight * effweight_GtoH );
						h_GtoH_pT->Fill( mu2.Pt, TotWeight * PUWeight * effweight_GtoH );
						h_GtoH_eta->Fill( mu1.eta, TotWeight * PUWeight * effweight_GtoH );
						h_GtoH_eta->Fill( mu2.eta, TotWeight * PUWeight * effweight_GtoH );
						h_GtoH_phi->Fill( mu1.phi, TotWeight * PUWeight * effweight_GtoH );
						h_GtoH_phi->Fill( mu2.phi, TotWeight * PUWeight * effweight_GtoH );
						...
						h_BtoF_leadPt->Fill( mu1.Pt, TotWeight * PUWeight * effweight_BtoF );
						h_BtoF_leadEta->Fill( mu1.eta, TotWeight * PUWeight * effweight_BtoF );
						h_BtoF_leadPhi->Fill( mu1.phi, TotWeight * PUWeight * effweight_BtoF );
						h_BtoF_subPt->Fill( mu2.Pt, TotWeight * PUWeight * effweight_BtoF );
						h_BtoF_subEta->Fill( mu2.eta, TotWeight * PUWeight * effweight_BtoF );
						h_BtoF_subPhi->Fill( mu2.phi, TotWeight * PUWeight * effweight_BtoF );

						h_GtoH_leadPt->Fill( mu1.Pt, TotWeight * PUWeight * effweight_GtoH );
						h_GtoH_leadEta->Fill( mu1.eta, TotWeight * PUWeight * effweight_GtoH );
						h_GtoH_leadPhi->Fill( mu1.phi, TotWeight * PUWeight * effweight_GtoH );
						h_GtoH_subPt->Fill( mu2.Pt, TotWeight * PUWeight * effweight_GtoH );
						h_GtoH_subEta->Fill( mu2.eta, TotWeight * PUWeight * effweight_GtoH );
						h_GtoH_subPhi->Fill( mu2.phi, TotWeight * PUWeight * effweight_GtoH );
				...
				{
					Muon mu1, mu2; // lead: 1, sub: 2
					if( SelectedMuonCollection0[0].Pt > SelectedMuonCollection0[1].Pt )
					{
						mu1 = SelectedMuonCollection0[0];
						mu2 = SelectedMuonCollection0[1];
					}
					else
					{
						mu1 = SelectedMuonCollection0[1];
						mu2 = SelectedMuonCollection0[2];
					}
