...
void EE_legacy(Int_t debug, Int_t type, Int_t remainder = 9999, Int_t isTopPtReweighting = 0, TString HLTname = "Ele23Ele12")
{
	...
	TString Output_ROOTFile = BaseDir+"/RESULT/EE/ROOTFile_20181205_EE_legacy_PVz_reweighting_with_PrefiringWeight_"+TString::Itoa(type,10)+"_"+TString::Itoa(remainder,10)+"_"
