...
#include "../../HEADER/DYAnalyzer_TightID_PFIso_v20180521_3.h"
...
//
void EE_REMOVE(Int_t debug, Int_t type, Int_t remainder = 9999, Int_t isTopPtReweighting = 0, TString HLTname = "Ele23Ele12")
{
	...
	TString Output_ROOTFile = BaseDir+"/RESULT/EE/ROOTFile_20190129_EE_PVz_reweighting_wo_PrefiringWeight_ER_" //ER: eta-restricted
